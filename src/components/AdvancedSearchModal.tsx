      ...
      <AnimatePresence>
        {isOpen && (
          <Dialog.Portal forceMount>
            ...
            <Dialog.Content className="fixed inset-0 z-50 flex items-center justify-center p-4" forceMount>
              <motion.div
              ...
              >
                ...
                <div className="flex items-center justify-between border-b border-slate-800 bg-slate-950 px-4 py-3">
                  ...
                  <Dialog.Close asChild>
                    <button
                      className="rounded-sm p-1 text-slate-400 hover:bg-slate-800 hover:text-slate-100 cursor-pointer"
                    >
                      <X className="h-4 w-4" />
                    </button>
                  </Dialog.Close>
                ...
                <div className="flex justify-end gap-2 border-t border-slate-800 bg-slate-950 px-4 py-3">
                  <Dialog.Close asChild>
                    <button
                      className="rounded-sm bg-blue-600 px-4 py-1.5 font-medium text-white hover:bg-blue-500 hover:shadow-md transition-all text-xs cursor-pointer"
                    >
                      Apply & Save Scopes
                    </button>
                  </Dialog.Close>
