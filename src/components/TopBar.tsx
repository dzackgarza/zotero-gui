...
import { Search, Sliders, Plus, Check } from 'lucide-react';
              ...
              <Tooltip.Root>
                ...
                <Tooltip.Portal>
                  <Tooltip.Content
                    side="bottom"
                    align="center"
                    className="z-50 rounded bg-slate-950 border border-slate-800 px-2.5 py-1.5 text-[10px] text-slate-350 font-sans shadow-md animate-fade-in"
                  >
        ...
        <div className="flex items-center gap-1.5">
          ...
          <DropdownMenu.Root>
            <DropdownMenu.Trigger asChild>
              <button
                className="p-1 px-1.5 bg-slate-900 border border-slate-800 hover:border-slate-700 text-[10px] rounded text-slate-350 hover:text-slate-100 font-mono cursor-pointer outline-hidden"
              >
              ...
              >
                {APP_THEMES.map(t => (
                  <DropdownMenu.Item
                    key={t}
                    onSelect={() => setTheme(t)}
                    className="w-full text-left px-2 py-1.5 hover:bg-slate-800 rounded-sm flex items-center justify-between cursor-pointer outline-hidden focus:bg-slate-800 select-none"
                  >
