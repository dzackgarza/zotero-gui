...
export default function CommandPalette({
  ...
  return (
    <CmdK.Dialog
      ...
      shouldFilter={false}
      className="fixed inset-0 z-50 flex items-start justify-center bg-black/40 backdrop-blur-xs pt-16 font-sans pointer-events-none"
    >
      <div className="w-full max-w-xl overflow-hidden rounded-lg border border-slate-700/60 bg-slate-900 text-slate-100 shadow-2xl shadow-black/80 pointer-events-auto">
        {/* Input field */}
